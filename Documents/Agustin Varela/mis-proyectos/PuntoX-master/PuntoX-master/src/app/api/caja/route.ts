...
export async function PATCH(req: NextRequest) {
  try {
    ...
    if (accion === "cerrar") {
      ...
      // Convertir BigInt y Decimal a Number para serialización
      return NextResponse.json({
        gasto: {
          ...
          EstaEliminado: nuevoGasto.EstaEliminado,
          ConceptoGastos: nuevoGasto.ConceptoGastos ? {
            Id: Number(nuevoGasto.ConceptoGastos.Id),
            Descripcion: nuevoGasto.ConceptoGastos.Descripcion,
          } : null,
        },
      });
    }
