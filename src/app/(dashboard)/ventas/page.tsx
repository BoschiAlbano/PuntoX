    ...
    <div className="max-w-[1400px] mx-auto py-4 sm:py-6 px-3 sm:px-6 flex flex-col items-stretch h-full relative space-y-4 sm:space-y-6">
      ...
      >
        ...
        <p className="text-slate-500 text-sm max-w-2xl leading-relaxed">
          Atiende a tus clientes, carga productos rápidamente y completa el pago
          en una interfaz fluida y optimizada.
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="flex-1 bg-white/40 backdrop-blur-2xl rounded-3xl border border-white/60 shadow-[0_8px_40px_rgba(0,0,0,0.03)]  overflow-hidden relative flex flex-col"
      >
