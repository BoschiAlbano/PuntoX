...
import { FiscalTabSkeleton } from "./ConfiguracionSkeleton";
          ...
          <VentasSection title="Situación fiscal (AFIP)" icon={FileText}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 px-1">
              <Select
                ...
                labelPlacement="outside"
                placeholder={
                  isLoadingCondiciones ? "Cargando..." : "Seleccioná condición"
                }
                variant="bordered"
                classNames={selectCls}
                selectedKeys={
              ...
              {errorCondiciones && (
                <p className="text-xs text-rose-500 font-medium col-span-2">
                  Error al cargar condiciones de IVA. Intentá recargar la
                  página.
                </p>
              )}
              ...
              <Input
                ...
                value={regional.cuit}
                onChange={(e) =>
                  setRegional({ ...regional, cuit: e.target.value })
                }
                startContent={
